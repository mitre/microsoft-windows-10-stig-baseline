...
control 'V-77191' do
  ...
  if input('sensitive_system') == 'true' || nil
    ...
    describe 'This STIG does not apply to Prior Versions before 1709.' do
     ...
     dep_enable = json( command: 'Get-ProcessMitigation -Name AcroRd32.exe | Select DEP | ConvertTo-Json').params
     ...
     describe 'Payload Enable Export Address Filter, Payload Enable Export Address Filter Plus, EnableImportAddressFilter, EnableRopStackPivot, EnableRopCallerCheck, and EnableRopSimExec are required to be enabled on Adobe Reader' do
       subject { payload }
